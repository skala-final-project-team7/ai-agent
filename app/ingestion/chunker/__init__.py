...
- metadata.py         build_metadata — 본문 청크 메타데이터 19종 부착 [feature3-B]
- attachment.py       첨부 docx/xlsx 분할 + chunk_attachment + infer_attachment_type [feature4-A]
                      (PDF/CSV는 feature4-B 예정)
"""
